#create a sequence of 50 equally space numbers between -4 and 4
x<-seq(-4,4,length=50)
...
#and add an x-axis with custom labels
plot(x,y,type="l",lwd=2, axes=FALSE,xlab="hello",ylab="goodbye")
