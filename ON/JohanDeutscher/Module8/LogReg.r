...
#Clean the data by adding values to the NA values in the age column
...
#Assign the fixed to ages column to the age column in df.train
df.train$Age<-fixed.ages

#If the output is false, then no NA values in the Age column
