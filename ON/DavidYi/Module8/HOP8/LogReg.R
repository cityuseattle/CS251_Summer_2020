...
print(ggplot(df.train, aes(Age)) + geom_histogram(bin=20, alpha=0.5, fill='blue'))
...
#Assign the fixed to ages col to the age col in df.train
...
#We will rerun our model using final.train set
final.train = subset (df.train, split == TRUE)

#2nd sub is final.test
