...
#In the above case there is an extreme value of 1047.s
...
#For example, it will remove 10% of the data from the top and 10 % from the bottom.
student.height1 <- c(100,106,121,111,109,111,103,117,114,NA,1047)
