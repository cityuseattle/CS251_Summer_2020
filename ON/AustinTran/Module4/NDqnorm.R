#Find the Z-score of the 81st quantile of that standard normal distribution
...
#Find the IQ score of the 95th quantile of normal distribution with mean 100 & sd=15
print(qnorm(0.95, mean=100, sd=15))
#To see your answer using graph
