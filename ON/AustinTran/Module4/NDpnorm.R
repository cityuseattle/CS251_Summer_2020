...
#Answer 2 :Find percentage of plants that are less than 14 inches tall, then subtract the
...
#Answer 3: Find percentage of males that are taller than 74 inches in a population with
#Mean = 70 and sd = 2
