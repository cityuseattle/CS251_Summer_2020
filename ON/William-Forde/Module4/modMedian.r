...
# Some external packages that do have this option.
# But right now, lets stick to R basic commands to find the mode.
# In this simple case, if we create a table, it will show,
# which height is repeated the most number of times
print(table(student.height))
# From this table, you can see that the height 111, is repeated the most (1 times) number of times,
